...
np.random.seed()
print("EXPERIMENT 6, depth=2, gamma=0.3, alpha=0.1, probablity=0.6 to 0.3 (-0.1 @ every 100000)")
win = 0
lose = 0
draw = 0
...
for i in range(1, 500001):
    result = run_training_game(GameState(), q_player, q_table, 2, probability, 0.6)
    if result > 0:
        win = win + 1
    elif result == 0:
        draw = draw + 1
